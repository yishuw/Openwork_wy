export default {
  ...
  settings: {
    ...
    toolProtocolHint: 'auto picks by model capability; fc uses OpenAI tools; xml is tag fallback',
    permissionMode: 'Permission',
    permissionModeHint: 'suggest confirms writes; auto-edit auto-writes and confirms bash; full-auto is unrestricted',
    protocolXml: 'XML (legacy)',
    protocolFc: 'Function Calling',
    protocolAuto: 'Auto (recommended)',
    permSuggest: 'Suggest (confirm writes)',
    permAutoEdit: 'Auto-edit (confirm bash)',
    permFullAuto: 'Full-auto (not recommended)',
  },
  placeholder: {
    title: 'OpenWork',
  ...
  approval: {
    ...
    deny: 'Deny',
    retry: 'Retry',
    networkError: 'Network error. Action not confirmed. Retry or deny.',
    alreadyResolved: 'Request timed out or already resolved',
