export default {
  ...
  settings: {
    ...
    mcpServer: 'MCP 服务器',
    toolProtocol: '工具协议',
    toolProtocolHint: 'auto 按模型能力自动选择；fc 为 OpenAI tools；xml 为兼容标签',
    permissionMode: '执行权限',
    permissionModeHint: 'suggest 写文件需确认；auto-edit 写文件自动、bash 需确认；full-auto 全部自动',
    protocolXml: 'XML（兼容）',
    protocolFc: 'Function Calling',
    protocolAuto: '自动（推荐）',
    permSuggest: '建议（写需确认）',
    permAutoEdit: '自动编辑（bash 需确认）',
    permFullAuto: '全自动（不推荐）',
  },
  placeholder: {
    title: 'OpenWork',
    hint: '打开文件夹或文件以开始编辑',
  ...
  approval: {
    ...
    deny: '拒绝',
    retry: '重试',
    networkError: '网络错误，操作未确认。请重试或拒绝。',
    alreadyResolved: '请求已超时或已被处理',
    timeout: '确认超时',
    path: '路径',
    command: '命令',
    content: '内容',
