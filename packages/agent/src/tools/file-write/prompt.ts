...
export const FILE_WRITE_TOOL_DESCRIPTION =
  'Write a file to the local filesystem. Creates a new file or overwrites an existing one.';
...
- Use this tool to CREATE new files or to do COMPLETE rewrites of existing files.
- For small targeted changes to an existing file, prefer the \`file_edit\` tool — it only sends the diff.
